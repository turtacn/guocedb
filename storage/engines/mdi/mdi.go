// Package mdi provides a placeholder for the MDI storage engine.
package mdi
...
// Storage is a placeholder for the MDI storage engine.
type Storage struct{}

// NewStorage returns a new instance of the MDI storage engine.
