// Package mdd provides a placeholder for the MDD storage engine.
package mdd
...
// Storage is a placeholder for the MDD storage engine.
type Storage struct{}

// NewStorage returns a new instance of the MDD storage engine.
